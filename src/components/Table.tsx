        ...
        return (
                <div className='px-2.5 sm:px-5 bg-[#F2F4F7]'>
                        ...
                        <table className=" w-full mt-3 md:mt-5 lg:mt-9 bg p-2 md:p-5 lg:p-9 shadow-md ">
                                ...
                                <tr>
                                        <td className="text-center bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">RULES</td>
                                        <td className="text-center bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">RULES</td>
                                        <td className="text-center bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">RULES</td>
                                        <td className="text-center bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">RULES</td>
                                        <td className="text-center bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">RULES</td>
                                        <td className="text-center bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">RULES</td>
                                ...
                                <tr>
                                        <td className="text-center bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">PROFIT SPLIT</td>
                                        <td className="text-center bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">PROFIT SPLIT</td>
                                        <td className="text-center bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">PROFIT SPLIT</td>
                                        <td className="text-center bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">PROFIT SPLIT</td>
                                        <td className="text-center bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">PROFIT SPLIT</td>
                                        <td className="text-center bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">PROFIT SPLIT</td>
                                ...
                                <tr>
                                        <td className="text-center bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">COST</td>
                                        <td className="text-center bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">FREE</td>
                                        <td className="text-center bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">FREE</td>
                                        <td className="text-center bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">FREE</td>
                                        <td className="text-center bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">FREE</td>
                                        <td className="text-center bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] ">FREE</td>
                                </tr>
                                <tfoot>
                                        <td className="bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] "></td>
                                        <td className="bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] text-center "><button className="  bg-[#000AFF] px-1.5 md:px-3  lg:px-6 py-2 text-white font-800 rounded-[8px]">PURCHASE</button></td>
                                        <td className="bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] text-center "><button className="  bg-[#000AFF] px-1.5 md:px-3  lg:px-6 py-2 text-white font-800 rounded-[8px]">PURCHASE</button></td>
                                        <td className="bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] text-center "><button className="  bg-[#000AFF] px-1.5 md:px-3  lg:px-6 py-2 text-white font-800 rounded-[8px]">PURCHASE</button></td>
                                        <td className="bg-white py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] text-center "><button className="  bg-[#000AFF] px-1.5 md:px-3  lg:px-6 py-2 text-white font-800 rounded-[8px]">PURCHASE</button></td>
                                        <td className="bg-[#66C7FB] py-1 md:py-1.5  lg:py-3 w-[16.6%] text-[8px] md:text-[10px]  lg:text-[14px] text-center "><button className="  bg-[#000AFF] px-1.5 md:px-3  lg:px-6 py-2 text-white font-800 rounded-[8px]">PURCHASE</button></td>
                                </tfoot>
