...
const RefundPolicy = () => {
  return (
    <div>
            ...
            <div>
                <p>However, we understand that in certain cases, you may need a refund. <span className='text-seco font-[700]'>If you notify us early and there are no trades placed on your account within the first 14 days, we may work with you to provide a refund.</span> For assistance with this type of scenario, please contact our live support.</p>
            </div>

            <div>
                <h1 className='text-heads font-bold text-base uppercase'>Dispute Policy:</h1>
                <p>Clients who <span className='text-seco font-[700]'>improperly dispute charges will face legal action and will be banned from our platform. Chargeback fraud is a significant issue in the prop firm industry.</span> Any traders who commit fraud through faulty chargebacks will have their names shared with other prop firms in the industry to ensure that bad actors do not have a lasting effect on prop firms.
                </p>
            </div>
